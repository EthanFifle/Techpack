...
This repository is build upon [Expressive Body Capture: 3D Hands, Face, and Body from a Single Image](https://smpl-x.is.tue.mpg.de/) and contains various contributions of my
own for educational purposes and my Capstone project.  
